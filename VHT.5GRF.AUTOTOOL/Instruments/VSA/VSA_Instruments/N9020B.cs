...
namespace _5GAutoTool
{
    public class N9020B
    {
        ...
        public string Name = "N9020B";
        public N9020B(Form5GAT mMainForm)
        {
            mainForm = mMainForm;
        }
        Ivi.Visa.Interop.ResourceManager rm = new Ivi.Visa.Interop.ResourceManager();
        Ivi.Visa.Interop.FormattedIO488 n9020b = new Ivi.Visa.Interop.FormattedIO488();
        ...
        {
            log.Log(text, logLevel, Name, "N9020B");
        }
        ...
        public void Connection(string IP, string Cmd, string Instrument, out string manufacturer, out string model, out string serial)
        {
            ...
            {
                //    Disconnect();
                n9020b.IO = (Ivi.Visa.Interop.IMessage)rm.Open("TCPIP::" + IP + "::INSTR", Ivi.Visa.Interop.AccessMode.NO_LOCK, 5, " ");
                n9020b.IO.Timeout = 2000;
                n9020b.WriteString(Cmd, true);
                object[] tmp;
                tmp = (object[])n9020b.ReadList(Ivi.Visa.Interop.IEEEASCIIType.ASCIIType_Any, ",");
        ...
        public void SendCommand(string cmd)
        {
            try
            {
                ...
                n9020b.WriteString("*ESR?", true);
                Log($"[CheckErrors] SEND: *ESR?");
                tmp = (object[])n9020b.ReadList(Ivi.Visa.Interop.IEEEASCIIType.ASCIIType_Any, ",");
                Log($"[CheckErrors] RECV: {string.Join(",", tmp)}");
                //if(error != "0")
                //{
                //    Log($"[n9020b]: [CheckErrors] Error Message: ", LogLevel.ERROR);
                //}
            }
            catch (Exception ex)
            {
        ...
        public void SetTriggerSource(string TriggerSoure)
        {
            ...
            {
                if (mainForm.measurementBackgroundWorker.CancellationPending) return;
                //n9020b.WriteString("CCAR:REF " + freq + "Hz", true);
                //Log("n9020b select center frequency: " + freq);
            }
            catch (Exception)
            {
        ...
        public void ACLRPower(int port, string TM, out string power, out string aclrAdjLower, out string aclrAdjUpper, out string aclrAlt1Lower, out string aclrAlt1Upper)
        {
            ...
            {
                if (mainForm.measurementBackgroundWorker.CancellationPending) return;
                n9020b.WriteString("READ:ACP?", true);
                System.Threading.Thread.Sleep(2000);
                object[] aclr;
                aclr = (object[])n9020b.ReadList(Ivi.Visa.Interop.IEEEASCIIType.ASCIIType_Any, ",");
                ...
                object[] n9020b_aclr = new object[] { aclr[1], aclr[5], aclr[7], aclr[4], aclr[6], aclr[9], aclr[11], aclr[8], aclr[10] };
                mainForm.DLCsvRecord(data, n9020b_aclr, result, "ACLR", TM, n9020b_aclr.Length, result.Length, port);
                Log(aclrAdjLower + "\n" + aclrAdjUpper + "\n" + aclrAlt1Lower + "\n" + aclrAlt1Upper);
            }
            catch
            {
        ...
        public void OBWMeas(int port, out string OBWMeas)
        {
            ...
            try
            {
                if (mainForm.measurementBackgroundWorker.CancellationPending) return;
                System.Threading.Thread.Sleep(2000);
                n9020b.WriteString("READ:OBW?", true);
                object[] obw;
                obw = (object[])n9020b.ReadList(Ivi.Visa.Interop.IEEEASCIIType.ASCIIType_Any, ",");
        ...
        public void EVMFreqErr(int port, string NRTM, out string[] evm, out string freqErr)
        {
            ...
            try
            {
                ...
                n9020b.WriteString("READ:EVM?", true);
                System.Threading.Thread.Sleep(4000);
                object[] n9020b_EVM;
                n9020b_EVM = (object[])n9020b.ReadList(Ivi.Visa.Interop.IEEEASCIIType.ASCIIType_Any, ",");
                string[] evmn9020b = new string[]
                {
                    n9020b_EVM[0].ToString(),
                    n9020b_EVM[22].ToString(),
                    n9020b_EVM[1].ToString(),
                    n9020b_EVM[2].ToString(),
                    n9020b_EVM[3].ToString(),
                    n9020b_EVM[4].ToString(),
                    n9020b_EVM[5].ToString(),
                    n9020b_EVM[6].ToString(),
                };
                evmN9020[10] = n9020b_EVM[0].ToString();
                if (NRTM == "NRTM_20")
                {
                    evmN9020[2] = n9020b_EVM[1].ToString(); //64QAM
                }
                else if (NRTM == "NRTM_20a")
                {
                    evmN9020[3] = n9020b_EVM[1].ToString(); //256QAM
                }
                ...
                {
                    evmN9020[1] = n9020b_EVM[1].ToString(); //16QAM
                }
                else if (NRTM == "NRTM_33")
                {
                    evmN9020[0] = n9020b_EVM[1].ToString(); //QPSK
                }
                freqErr = n9020b_EVM[3].ToString();
                mainForm.DLCsvRecord(data, evmn9020b, null, "EVM_FreqError", NRTM, evmn9020b.Length, 0, port);
                Log("OFDM Power: " + evmN9020[10] + "\n" + "Freq " + freqErr + "\n" + "EVM: " + n9020b_EVM[1].ToString());
            }
            catch
            {
        ...
        public void OFDMPower(out string power)
        {
            ...
            try
            {
                ...
                object[] n9020b_Power;
                n9020b_Power = (object[])n9020b.ReadList(Ivi.Visa.Interop.IEEEASCIIType.ASCIIType_Any, ",");
                power = n9020b_Power[22].ToString();
            }
            catch
            {
                Log("EVM Measurement: FAIL", LogLevel.ERROR);
        ...
        internal void TransONOFFMeas(string mode, string TM, out string offPower, out string transPeriod, int port)
        {
            ...
            try
            {
                ...
                System.Threading.Thread.Sleep(5000);
                AutoScale();
                n9020b.WriteString("MEAS:PVT?", true);
                object[] n9020b_TransONOFF;
                n9020b_TransONOFF = (object[])n9020b.ReadList(Ivi.Visa.Interop.IEEEASCIIType.ASCIIType_Any, ",");
                offPower = Math.Round(double.Parse(n9020b_TransONOFF[7].ToString()), 3).ToString();
                Rising_Period = Math.Round(double.Parse(n9020b_TransONOFF[5].ToString()) * 1e6, 3).ToString();
                Falling_Period = Math.Round(double.Parse(n9020b_TransONOFF[6].ToString()) * 1e6, 3).ToString();
                string[] OnOff9020a = new string[]
                {
                    n9020b_TransONOFF[2].ToString(),
                    n9020b_TransONOFF[7].ToString(),
                    n9020b_TransONOFF[8].ToString(),
                    n9020b_TransONOFF[9].ToString(),
                    n9020b_TransONOFF[5].ToString(),
                    n9020b_TransONOFF[6].ToString(),
                };
        ...
        public void SEMMeas(int port, string TM, out double absPwr1, out double absPwr2, out double absPwr3, out double semLimit)
        {
            ...
            try
            {
                n9020b.WriteString("READ:SEM?", true);
                System.Threading.Thread.Sleep(10000);
                object[] n9020b_SEM;
                #region Convertdata
                n9020b_SEM = (object[])n9020b.ReadList(Ivi.Visa.Interop.IEEEASCIIType.ASCIIType_Any, ",");
                string limit1 = n9020b_SEM[70].ToString();  //Minimum margin from limit line on the negative offset A
                string limit2 = n9020b_SEM[71].ToString();  //Minimum margin from limit line on the positive offset A
                string limit3 = n9020b_SEM[72].ToString();  //Minimum margin from limit line on the negative offset B
                string limit4 = n9020b_SEM[73].ToString();  //Minimum margin from limit line on the positive offset B
                string limit5 = n9020b_SEM[74].ToString();
                string limit6 = n9020b_SEM[75].ToString();
                // limitmax
                string absPower1 = n9020b_SEM[13].ToString(); //Abs peak power on the negative offset A(dBm)
                string absPower2 = n9020b_SEM[18].ToString(); //Abs peak power on the positive offset A (dBm)
                string absPower3 = n9020b_SEM[23].ToString();
                string absPower4 = n9020b_SEM[28].ToString();
                string absPower5 = n9020b_SEM[33].ToString();
                string absPower6 = n9020b_SEM[38].ToString();
                //Freq
                string FreqNegative1 = n9020b_SEM[14].ToString();
                string FreqPositive1 = n9020b_SEM[19].ToString();
                int Freq1 = Math.Max(Math.Abs(int.Parse(FreqNegative1)), Math.Abs(int.Parse(FreqPositive1)));
                string FreqNegative2 = n9020b_SEM[24].ToString();
                string FreqPositive2 = n9020b_SEM[29].ToString();
                int Freq2 = Math.Max(Math.Abs(int.Parse(FreqNegative2)), Math.Abs(int.Parse(FreqPositive2)));
                string FreqNegative3 = n9020b_SEM[34].ToString();
                string FreqPositive3 = n9020b_SEM[39].ToString();
        ...
        public void IMDACLR(string offset, out double aclr)
        {
            ...
            try
            {
                ...
                n9020b.WriteString("READ:ACP?", true);
                object[] obj;
                obj = (object[])n9020b.ReadList(Ivi.Visa.Interop.IEEEASCIIType.ASCIIType_Any, ",");
        ...
        public void IMDSEM(string offset, out string semLimit)
        {
            ...
            try
            {
                ...
                object[] n9020b_SEM;
                n9020b_SEM = (object[])n9020b.ReadList(Ivi.Visa.Interop.IEEEASCIIType.ASCIIType_Any, ",");
                limit1 = n9020b_SEM[70].ToString();
                limit2 = n9020b_SEM[71].ToString();
                limit3 = n9020b_SEM[72].ToString();
                limit4 = n9020b_SEM[73].ToString();
                limit5 = n9020b_SEM[74].ToString();
                limit6 = n9020b_SEM[75].ToString();
                limit7 = n9020b_SEM[76].ToString();
                limit8 = n9020b_SEM[77].ToString();
                Log(limit1 + "\n" + limit2 + "\n" + limit3 + "\n" + limit4 + "\n" + limit5 + "\n" + limit6 + "\n" + limit7 + "\n" + limit8);
        ...
        public void SetupIMDTSE(SpuriousRange rng)
        {
            try
            {
                ...
                SingleSweepOnOff(0);
                //get result                
                n9020b.WriteString("CALC:MARK1:X? ", true);
                object[] tseX = (object[])n9020b.ReadList(Ivi.Visa.Interop.IEEEASCIIType.ASCIIType_Any, ",");
                n9020b.WriteString("CALC:MARK1:Y? ", true);
                object[] tseY = (object[])n9020b.ReadList(Ivi.Visa.Interop.IEEEASCIIType.ASCIIType_Any, ",");
                n9020b.WriteString(":CALC:TRAC1:FAIL? ", true);
                object[] tsePF = (object[])n9020b.ReadList(Ivi.Visa.Interop.IEEEASCIIType.ASCIIType_Any, ",");
        ...
        public void IMDTSEMMeas(string mode, out double amp1, out double amp2, out double amp3)
        {
            ...
            try
            {
                ...
                if (mainForm.measurementBackgroundWorker.CancellationPending) return;
                System.Threading.Thread.Sleep(1);
                n9020b.WriteString(":READ:SPUR?", true);
                System.Threading.Thread.Sleep(5000);
                object[] transmitterSpuriousEmission;
                transmitterSpuriousEmission = (object[])n9020b.ReadList(Ivi.Visa.Interop.IEEEASCIIType.ASCIIType_Any, ",");
                if (mode == "AC")
                {
        ...
        internal void ACLRPower(int port, string TM, out double intraACLR, string mode)
        {
            ...
            try
            {
                ...
                object[] n9020b_aclr = new object[] { aclr[1], aclr[5], aclr[7], aclr[4], aclr[6], aclr[9], aclr[11], aclr[8], aclr[10] };
                mainForm.DLCsvRecord(data, n9020b_aclr, result, mode, TM, n9020b_aclr.Length, result.Length, port);
                Log(aclrAdjLower + "\n" + aclrAdjUpper + "\n" + aclrAlt1Lower + "\n" + aclrAlt1Upper);
            }
            catch
            {
        ...
        public void TransferFileToPC(string filename)
        {
            ...
            n9020b.WriteString($":MMEM:DATA? \"{filename}\"");
            byte[] data = (byte[])n9020b.ReadIEEEBlock(Ivi.Visa.Interop.IEEEBinaryType.BinaryType_UI1);
        ...
        public void LoadSpurSetup(string coupling, string mode, string Freq, string RBW)
        {
            try
            {
                ...
                if (mainForm.measurementBackgroundWorker.CancellationPending) return;
                System.Threading.Thread.Sleep(1000);
                n9020b.WriteString($"MMEM:LOAD:STAT 1,'{filename}'", true);
        ...
        public void SpurMeas(int port, out double?[] spur)
        {
            ...
            try
            {
                if (mainForm.measurementBackgroundWorker.CancellationPending) return;
                System.Threading.Thread.Sleep(2000);
                n9020b.WriteString("READ:SPUR?", true);// Queries the peak list of the spurious emission measurement 
                //convert data
                object[] Spur;
                Spur = (object[])n9020b.ReadList(Ivi.Visa.Interop.IEEEASCIIType.ASCIIType_Any, ",");
                while (Spur.Length % 7 == 0)
                {
                    ...
                    for (int i = 0; i < n; i++)
                    {
                        range[i] = Spur[i * 7].ToString();
                        //rbw[i] = Spur[i * 7 + 3].ToString();
                        freq[i] = Spur[i * 7 + 3].ToString();
                        //abs[i] = double.Parse(Spur[i * 7 + 5].ToString());
                        spur[i] = double.Parse(Spur[i * 7 + 4].ToString());
        ...
        internal void Restart()
        {
            try
            {
                n9020b.WriteString($":INIT:IMM", true);
                n9020b.WriteString($":INIT:REST", true);
            }
            catch (Exception ex)
            {
                log.Log(ex.Message, LogLevel.ERROR);
    ...
    //        if (tmp[1].ToString() == Instrument)
    //        {
    //            Log("N9020B: connected to " + IP, LogLevel.SUCCESS);
    //        }
    //    }
    //    catch (Exception e)
    //    {
    //        Log("N9020B connect: fail", LogLevel.ERROR);
    //    }
    //}
    ...
    //        }
    //        n9020b.WriteString(cmd, true);
    //        Log($"[N9020A]: [Querry] SEND: {cmd}");

    //        object[] tmp;
    //        tmp = (object[])n9020b.ReadList(Ivi.Visa.Interop.IEEEASCIIType.ASCIIType_Any, ",");
    //        Log($"[N9020A]: [Querry] RECV: {string.Join(",", tmp)}");

    //        n9020b.WriteString("*ESR?", true);
    //        Log($"[N9020A]: [CheckErrors] SEND: *ESR?");
    //        tmp = (object[])n9020b.ReadList(Ivi.Visa.Interop.IEEEASCIIType.ASCIIType_Any, ",");
    //        Log($"[N9020A]: [CheckErrors] RECV: {string.Join(",", tmp)}");
    //        //if(error != "0")
    //        //{
    ...
    //    catch (Exception ex)
    //    {
    //        Log($"[N9020A] Send command:{cmd} FAIL! " + ex.Message, LogLevel.ERROR);
    //    }
    //}
    ...
    //    catch (Exception)
    //    {
    //        Log("N9020B select center frequency: FAIL", LogLevel.ERROR);
    //    }
    //}
    //public void SetAtt(string att)
    //{
    ...
    //    {
    //        if (mainForm.measurementBackgroundWorker.CancellationPending) return;
    //        n9020b.WriteString("CORR:BTS:GAIN -" + att + " dB", true);
    //        System.Threading.Thread.Sleep(200);
    //        n9020b.WriteString("DISP:CHP:WIND:TRAC:Y:RLEV 50 dBm", true);
    //        Log("N9020B ref lever Offset: " + att);
    //    }
    //    catch (Exception)
    //    {
    //        Log("N9020B sets an external gain:  FAIL", LogLevel.ERROR);
    //    }
    //}
    //public void AutoScale()
    //{
    //    n9020b.WriteString("POW:RANG:OPT IMM", true); // auto scale window
    //    System.Threading.Thread.Sleep(7000);
    //}
    //public void LoadACLRSetup(string BW, string TDDFDD)
    //{
    ...
    //        if (mainForm.measurementBackgroundWorker.CancellationPending) return;
    //        System.Threading.Thread.Sleep(1000);
    //        n9020b.WriteString($@":MMEM:LOAD:STAT 'D:\Users\Instrument\Documents\NR5G\state\ACLR\ACLR_{BW}Mhz_{TDDFDD}.state'", true);
    //        Log("N9020B load ACLR measurement: ACLR_" + BW + "_" + TDDFDD);
    //    }
    //    catch (Exception)
    //    {
    //        Log("N9020B Load ACLR Setup: FAIL", LogLevel.ERROR);
    //    }
    //}
    //public void ACLRPower(int port, string TM, out string power, out string aclrAdjLower, out string aclrAdjUpper, out string aclrAlt1Lower, out string aclrAlt1Upper)
    //{
    ...
    //    catch
    //    {
    //        Log("N9020B ACLR Measurement: FAIL", LogLevel.ERROR);
    //    }
    //}
    ...
    //        if (mainForm.measurementBackgroundWorker.CancellationPending) return;
    //        System.Threading.Thread.Sleep(3000);
    //        n9020b.WriteString($@":MMEM:LOAD:STAT 'D:\Users\Instrument\Documents\NR5G\state\OBW\OBW_{BW}Mhz.state'", true);
    //        Log("N9020B  load OBW measurement: OBW_" + BW + "Mhz");
    //    }
    //    catch
    //    {
    //        Log("N9020B Load OBW Setup: FAIL", LogLevel.ERROR);
    //    }
    //}
    //public void OBWMeas(int port, out string OBWMeas)
    //{
    ...
    //    catch
    //    {
    //        Log("N9020B load OBW measurement: FAIL", LogLevel.ERROR);
    //    }
    //}
    ...
    //        if (mainForm.measurementBackgroundWorker.CancellationPending) return;
    //        System.Threading.Thread.Sleep(1000);
    //        n9020b.WriteString(":MMEM:LOAD:STAT " + "\"" + "D:/Users/Instrument/Documents/NR5G/state/NRTM/" + NRTMxx + "_7D1S2U" + ".state" + "\"", true);
    //        Log("N9020B load NRTM measurement: " + NRTMxx);
    //    }
    //    catch
    //    {
    //        Log("N9020B load NRTM measurement: FAIL", LogLevel.ERROR);
    //    }
    //}
    //string[] evmN9020 = new string[13];
    //public void EVMFreqErr(int port, string NRTM, out string[] evm, out string freqErr)
    ...
    //    catch
    //    {
    //        Log("N9020A EVM Measurement: FAIL", LogLevel.ERROR);
    //    }
    //}
    //public void OFDMPower(out string power)
    //{
    ...
    //        System.Threading.Thread.Sleep(5000);
    //        object[] n9020A_Power;
    //        n9020A_Power = (object[])n9020b.ReadList(Ivi.Visa.Interop.IEEEASCIIType.ASCIIType_Any, ",");
    //        power = n9020A_Power[22].ToString();
    //    }
    //    catch
    //    {
    //        Log("N9020B EVM Measurement: FAIL", LogLevel.ERROR);
    //    }
    //}
    ...
    //        if (mainForm.measurementBackgroundWorker.CancellationPending) return;
    //        System.Threading.Thread.Sleep(1);
    //        n9020b.WriteString(":MMEM:LOAD:STAT " + "\"" + "D:/Users/Instrument/Documents/NR5G/state/OSTP_POWER.state" + "\"", true);
    //        Log("N9020B Chanel Power measurement: ");
    //    }
    //    catch
    //    {
    //        Log("N9020B load NRTM measurement: FAIL", LogLevel.ERROR);
    ...
    //        if (mainForm.measurementBackgroundWorker.CancellationPending) return;
    //        System.Threading.Thread.Sleep(1);
    //        n9020b.WriteString(":MMEM:LOAD:STAT " + "\"" + "D:/Users/Instrument/Documents/NR5G/state/ONOFFPOWER/TransmitONOFFpower.state" + "\"", true);
    //        Log("N9020B ONOFF Power measurement: ");
    //    }
    //    catch
    //    {
    //        Log("N9020B load NRTM measurement: FAIL", LogLevel.ERROR);
    ...
    //        n9020a_TransONOFF = (object[])n9020b.ReadList(Ivi.Visa.Interop.IEEEASCIIType.ASCIIType_Any, ",");
    //        offPower = n9020a_TransONOFF[7].ToString();
    //        Rising_Period = n9020a_TransONOFF[5].ToString();
    //        Falling_Period = n9020a_TransONOFF[6].ToString();
    //        string[] OnOff9020a = new string[]
    //        {
    ...
    //    catch
    //    {
    //        Log("N9020B TransON/OFF measurement: FAIL", LogLevel.ERROR);
    //    }
    //}
    ...
    //    catch
    //    {
    //        Log("N9020B OFDM Power measurement: FAIL", LogLevel.ERROR);
    //    }
    //}
    //public void LoadSEMSetup(string BW, string TDDFDD)
    //{
    ...
    //        if (mainForm.measurementBackgroundWorker.CancellationPending) return;
    //        System.Threading.Thread.Sleep(1);
    //        n9020b.WriteString(":MMEM:LOAD:STAT " + "\"" + "D:/Users/Instrument/Documents/NR5G/state/SEM/SEM_" + BW + "Mhz.state" + "\"", true);
    //        Log("N9020B load SEM measurement: SEM_" + BW + "_" + TDDFDD);
    //    }
    //    catch
    //    {
    //        Log("N9020B Load SEM Setup: FAIL", LogLevel.ERROR);
    ...
    //        object[] n9020a_SEM;
    //        #region Convertdata
    //        n9020a_SEM = (object[])n9020b.ReadList(Ivi.Visa.Interop.IEEEASCIIType.ASCIIType_Any, ",");
    ...
    //    catch
    //    {
    //        Log("N9020B SEM measurement: FAIL", LogLevel.ERROR);
    //    }
    //}
    //public void LoadIMDACLR(string offset)
    //{
    ...
    //        if (mainForm.measurementBackgroundWorker.CancellationPending) return;
    //        System.Threading.Thread.Sleep(1000);
    //        n9020b.WriteString(":MMEM:LOAD:STAT " + "\"" + "D:/Users/Instrument/Documents/NR5G/state/IMD/IMD_ACLR/IMD_ACLR_" + offset + "MHz.state" + "\"", true);
    //        Log("D:/Users/Instrument/Documents/NR5G/state/IMD/IMD_ACLR/IMD_ACLR_" + offset + "MHz.state");
    //    }
    //    catch
    //    {
    ...
    //    catch (Exception)
    //    {
    //        Log("N9020B IMD ACLR Measurement: FAIL", LogLevel.ERROR);
    //    }
    //}
    ...
    //        if (mainForm.measurementBackgroundWorker.CancellationPending) return;
    //        System.Threading.Thread.Sleep(1);
    //        n9020b.WriteString(":MMEM:LOAD:STAT " + "\"" + "D:/Users/Instrument/Documents/NR5G/state/IMD/IMD_SEM/IMD_SEM_OFF" + offset + "MHz.state" + "\"", true);
    //        Log("Load File: " + "D:/Users/Instrument/Documents/NR5G/state/IMD/IMD_SEM/IMD_SEM_OFF" + offset + "MHz.state");
    //    }
    //    catch
    //    {
    //        Log("N9020B Load Transmitter Spurious Emission Setup: FAIL", LogLevel.ERROR);
    //    }
    //}
    //public void IMDSEM(string offset, out string semLimit)
    //{
    ...
    //            }
    //        }
    //        n9020b.WriteString(":MMEM:LOAD:STAT " + "\"" + filename + "\"", true);
    //        Log("N9020B load: " + filename);
    //    }
    //    catch
    //    {
    //        Log("N9020B Load Transmitter Spurious Emission Setup: FAIL", LogLevel.ERROR);
    ...
    //    catch
    //    {
    //        Log("N9020B Spurious emission measurement: FAIL", LogLevel.ERROR);
    //    }
    //}
    ...
    //        if (onOff == 0)
    //        {
    //            n9020b.WriteString("INIT:CONT OFF");
    //            System.Threading.Thread.Sleep(5000); //time for VSA change to Ready
    //            Log("N9020B: Changed to Single Sweep");
    //        }
    //        else if (onOff == 1)
    //        {
    //            n9020b.WriteString($"INIT:CONT ON");
    //            //System.Threading.Thread.Sleep(2000); //time for VSA change to Ready
    //            Log("N9020B: Changed to Continous Sweep");
    //        }
    //        else
    //        {
    //            Log("[Error]N9020B: Init SingleSweep/ContinousSweep parameter invalid", LogLevel.ERROR);
    //        }
    //    }
    //    catch (Exception ex)
    //    {
    //        Log("[Error]N9020B: Change Single Sweep mode got an error! " + ex.Message);
    //    }
    //}
    //public void TakeScreenshot(string filePathVSA)
    //{
    //    try
    //    {
    //        n9020b.WriteString($":MMEM:STOR:SCR \"{filePathVSA}\"");

    //        Log($"N9020A Screenshot saved to: {filePathVSA}", LogLevel.ERROR);
    //        //save to remote PC
    //        TransferFileToPC(filePathVSA);
    //    }
    //    catch (Exception ex)
    //    {
    //        Log("[Error]N9020A:Save Screenshot got an error! " + ex.Message, LogLevel.ERROR);
    //    }
    //}
    //public void SaveCSVFile(string filePathVSA)
    //{
    //    try
    //    {
    //        n9020b.WriteString($":MMEM:STOR:TRAC:DATA TRACE1, \"{filePathVSA}\""); //save the marker table
    //        Log($"N9020A saved measurement data to: {filePathVSA}");
    //        //save to remote PC
    //        TransferFileToPC(filePathVSA);
    //    }
    //    catch (Exception ex)
    //    {
    //        Log("[Error]N9020A Save data fail! " + ex.Message, LogLevel.ERROR);
    //    }
    //}
